    ...
    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '20px 20px 4px' }}>
      {left ?? (
        <div className="hf-avatarpill">
          {/* 💡 조잡한 '···' 버튼을 지우고 프로필만 깔끔하게 노출 */}
          <div className="avatar" style={{ marginLeft: 0 }}>김</div>
        </div>
      )}
...
// 💡 마켓 제거 및 랭킹 전환에 따른 트로피 모양 SVG 적용 완료
const TAB_ICONS = {
  ...
  comm:   <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M6 9H4.5a2.5 2.5 0 0 1 0-5H6M18 9h1.5a2.5 2.5 0 0 0 0-5H18M4 22h16M10 14.66V17c0 .55-.45 1-1 1H4v2h16v-2h-5c-.55 0-1-.45-1-1v-2.34M12 2a4 4 0 0 1 4 4v6H8V6a4 4 0 0 1 4-4z"/></svg>,
...
export function TabBar() {
  ...
  const tabs = [
    ...
    { id: 'comm',   to: '/ranking',   label: '랭킹',    match: ['/ranking'] },
...
{/* 💡 [해결] 템플릿 리터럴 백틱(`)을 정상적으로 닫고, 잘린 구문을 안전하게 전면 마감 완료 */}
